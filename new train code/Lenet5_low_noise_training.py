...
numtrain = 485 * 6 * 12 # 第一个数字应该是总共的label含有重复的
numval = 6984
...
cnn_model.add(Dense(480, activation = 'softmax', activity_regularizer = keras.regularizers.l2(0.1)))
...
cnn_model.fit(X_train.reshape(numrest, 2251, 1), y_train.values, batch_size = 128, epochs = 40, verbose = 1)
